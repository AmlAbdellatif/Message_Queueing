...
"""
queue_url = "https://sqs.eu-west-1.amazonaws.com/086809522012/new-sqs"
max_number_of_messages = 1
wait_time_seconds = 20
region = "eu-west-1"
response = receive_message(queue_url, max_number_of_messages, wait_time_seconds, region)
...
if check=='aws:s3'  :
      ...
      for message in messages_list:
        ...
        response = delete_message(queue_url, receipt_handle, region)
        print(response)
else:
